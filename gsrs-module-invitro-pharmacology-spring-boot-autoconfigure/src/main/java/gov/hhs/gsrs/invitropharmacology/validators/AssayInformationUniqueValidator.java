    ...
    public void validate(InvitroAssayInformation objnew, InvitroAssayInformation objold, ValidatorCallback callback) {
        ...
        if (assayExists != null) {
            ...
            if ((objnew.id == null) || (!assayExists.id.equals(objnew.id))) {
                callback.addMessage(GinasProcessingMessage.ERROR_MESSAGE("AssayInformationUniqueValidatorError", "The combination of External Assay Source and External Assay ID already exist in the database."));
            }
        }
